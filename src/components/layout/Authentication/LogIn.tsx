...
export default function LoginComponent() {
  ...
  const blockingOrInvalid = blocking || !isFormValid;
                    ...
                    <Box component="form" onSubmit={onSubmit} noValidate>
                      ...
                      <div className="mt-2 mb-2 flex w-full items-center justify-between">
                        <FormControlLabel
                          ...
                          label="Remember me"
                        />
                        <a href="#" className=" hover:text-indigo-400 text-sm/2">Forgot password?</a>
                      </div>
                        ...
                        fullWidth
                        variant="contained"
                        disabled={blocking || !isFormValid}
                        sx={{ mt: 2, opacity: !isFormValid ? 0.6 : 1 }}
                        >
