  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
      {stats.map((stat, index) => (
             <div className="bg-white/80 shadow-xl dark:bg-slate-900/80 backdrop-blur-xl rounded-2xl p-6 border border-slate-200/50 dark:border-slate-700/50 hover:shadow-xl hover:shadow-slate-200/20 dark:hover:shadow-slate-900/20 transition-all duration-300 group" 
             key={index}>
                ...
                {/* Progressbar */}
                <div className="mt-4 h2 bg-slate-100 dark:bg-slate-800 rouded-full overflow-hidden">
                    <div 
                ...
                {/* Progressbar */}
                <div className="mt-4 h-2 bg-slate-100 dark:bg-slate-800 rouded-full overflow-hidden">
                    <div 
